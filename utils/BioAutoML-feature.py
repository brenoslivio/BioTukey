...
if __name__ == '__main__':
	...
	if len(fasta_label_train) > 2:
		subprocess.run(['python', 'utils/BioAutoML-multiclass.py', '-train', path_train,
		...
		subprocess.run(['python', 'utils/BioAutoML-binary.py', '-train', path_train,
